...
export function FixedPriceOfferForm({
  ...
  return (
    <div className="mt-3">
      ...
      {open ? (
        <div
          className="fixed inset-0 z-50 flex items-end bg-zinc-900/40 p-2 sm:items-center sm:justify-center sm:p-4"
          role="dialog"
          aria-modal="true"
        ...
        >
          <div
            ref={modalRef}
            className="max-h-[95vh] w-full overflow-y-auto rounded-2xl border border-zinc-200 bg-white p-4 shadow-2xl shadow-zinc-900/15 ring-1 ring-zinc-900/5 sm:max-w-lg sm:p-6"
          >
              ...
              <div className="flex items-start gap-3">
                {thumbnailUrl ? (
                  <Image
                    ...
                    height={72}
                    unoptimized
                    className="h-[72px] w-[72px] rounded-md border border-zinc-200 object-cover"
                  />
                ) : null}
