...
const scoreButtonClass =
  "min-w-[2.75rem] rounded-md border border-zinc-300 bg-white px-2 py-2 text-sm font-semibold tabular-nums text-zinc-900 transition hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50";
